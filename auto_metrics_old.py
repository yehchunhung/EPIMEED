...
with open('./auto-metrics/auto-metrics-listener-red+_mask_meed2+.csv', 'a') as outfile:
    ...
    for model_name in ['xenbot-os-dramatic-rest']:
...
#                     read_path = './prediction/{}/meed2/{}-{}.csv'.format(dataset, model_name, version)
                    read_path = './prediction-listener/{}/meed2/{}-{}_-{}.csv'.format(dataset, model_name, dataset, version)
                elif version == 'meed2+':
#                     read_path = './prediction/{}/meed2/{}-{}.csv'.format(dataset, model_name, version)
                    read_path = './prediction-listener/{}/meed2/{}-{}+-{}.csv'.format(dataset, model_name, dataset, version)
                elif version == 'plain':
#                     read_path = './prediction/{}/{}/{}-{}.csv'.format(dataset, version, model_name.replace('xenbot', 'plain'), version)
                    read_path = './prediction-listener/{}/plain/{}-{}-{}.csv'.format(dataset, model_name, dataset, version)
                elif version == 'alexa':
