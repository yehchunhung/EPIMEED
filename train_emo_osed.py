...
#checkpoint_path = 'checkpoints_ebp/emo_pred_osed_roberta_ebp'
#log_path = 'log_ebp/emo_pred_osed_roberta_ebp.log'
#data_path = '../os/osed_emobert'


restore_epoch = 2
restore_path = 'emo_checkpoints/os-dramatic-rest'
checkpoint_path = './emo_checkpoints/os-dramatic-rest-osed-dramatic'
log_path = 'emo_log/os-dramatic-rest-osed-dramatic.log'
data_path = './datasets/osed-dramatic'
...
def main():
    ...
    with mirrored_strategy.scope():
        ...
        # print('Epoch 0 Validation loss {:.4f}\n'.format(epoch_val_loss))
        # f.write('Epoch 0 Validation loss {:.4f}\n\n'.format(epoch_val_loss))
