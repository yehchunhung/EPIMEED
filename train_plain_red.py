...
from model_plain import PlainTransformer, loss_function, loss_function_
from datasets import *


# Some hyper-parameters
num_layers = 4
d_model = 300 # use 512 or 1024
num_heads = 6 # use 8 or 16
dff = d_model * 4
...
restore_epoch = 50
restore_path = './checkpoints/plain-os-dramatic-rest'
checkpoint_path = './checkpoints/plain-os-dramatic-rest-red+_mask' 
log_path = './log/plain-os-dramatic-rest-red+_mask.log'
data_path = './datasets/red+_mask' # './datasets/red/emo_prepend'
...
def main():
    ...
    with mirrored_strategy.scope():
        # original
        # train_dataset, val_dataset, test_dataset = create_datasets(tokenizer, data_path, buffer_size, batch_size, max_length)
        ...
        def train_step(dist_inputs):
            def step_fn(inputs):
                ...
                with tf.GradientTape() as tape:
                    ...
                    # loss_ = loss_function(tar_real, pred)
                    loss_ = loss_function_(tar_real, pred, tar_mask)
